        ...
        <>
            ...
            <div className="flex flex-col lg:flex-row mt-16 justify-center p-4 bg-gray-50 min-h-screen">
                ...
                <div className="flex flex-col  md:flex-row lg:items-stretch w-full max-w-7xl bg-white shadow-lg rounded-xl p-6 lg:p-10 gap-15">
                    ...
                    <div className="flex flex-col flex-wrap w-full max-w-md sm:m-auto lg:max-w-none text-left flex-grow space-y-0">
                        ...
                        <div className="space-y-3 mt-4">
                            ...
                            {[1, 2, 3, 4, 5, 6, 7, 8].map((course) => (
                                <div key={course} >
                                    ...
                                    <label htmlFor="" className="block text-sm font-medium text-gray-700 ml-2 mb-1">
                                        Select Course {course}
                                    </label>
                                    <select id="" className="mt-1 block w-full pl-4 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md shadow-sm"
                                        defaultValue="">
